...
- [ ] 06.2-16-PLAN.md — Table rebuilt as three fixed reserved regions that never grow or reflow (gap 1)
- [ ] 06.2-17-PLAN.md — Tile colour as a translucent darkening overlay above the card art (gap 7)
