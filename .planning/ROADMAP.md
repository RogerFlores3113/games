...
- [x] 06.2-03-PLAN.md — Pure hint derivation and lifetime, keep-hints and tile-colour preferences

**Wave 2** *(blocked on Wave 1)*

- [x] 06.2-04-PLAN.md — Hint indicators on tiles, pip band deleted, raised tile surface (HINT-01/02/04, TILE-01)
- [x] 06.2-05-PLAN.md — Clue/fuse token art, shrinking token column, fanned played stacks (BOARD-02/03/05)
...
- [x] 06.2-07-PLAN.md — Table layout rework: wooden board, labelled Play/Discard, deck counter, token column (BOARD-01..05, TILE-02)

**Wave 5** *(blocked on Wave 4)*

- [x] 06.2-08-PLAN.md — Discard drag: pure drop logic, useDiscardDrag, reorderDiscard dispatch (DISC-01)
- [x] 06.2-09-PLAN.md — Drag shift-aside gap preview in the hand (DRAG-01)

**Wave 6** *(blocked on Wave 5)*

- [x] 06.2-10-PLAN.md — Playwright proofs for every behavioural requirement + measured 1280x720 worst-case fit

**Wave 7** *(blocked on Wave 6)*

- [x] 06.2-11-PLAN.md — Phase gate + owner visual sign-off recorded verbatim (checkpoint) — owner rejected: "no, bad job", ten gaps recorded in 06.2-HUMAN-UAT.md
...
- [x] 06.2-13-PLAN.md — Settings modal behind a top-right gear; bottom row keeps only play controls (gap 8)
- [x] 06.2-14-PLAN.md — Blue-outlined clue tokens at 2x size in a fixed slot grid, count text moved to screen readers (gaps 4, 5, 6)
...
- [x] 06.2-19-PLAN.md — Worst-case 1280x720 fit re-measure, ledger reconciliation, UI-SPEC update
...
- [x] 07-01-PLAN.md — Server fix: canClue rejects non-nameable colours (clue_color_not_nameable) threaded through rules, schema, worker; regression + property tests
- [x] 07-02-PLAN.md — Engine end-condition coverage per variant (D-16) and UI-07 rainbow glyph/gradient render checks (D-11)

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 07-03-PLAN.md — Rainbow tile quick-clue colour row (D-05..D-08) with anchor flip; row-aware e2e helpers
...
- [x] 07-06-PLAN.md — Board widened for a 7th suit column (MAX_SUITS 7, tiles unchanged 50x65), real-browser before/after fit measurement at 1280x720, 5 seats
...
| 7. Variant Support (Rainbow, Black) | 9/13 | In Progress|  |
